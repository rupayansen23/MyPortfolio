...
const Projects = () => {
  ...
  const projects = [
    {
      title: "BookLoversa",
      description: "An AI-based e-commerce book store designed to help users discover, browse, and shop books with a smarter shopping experience.",
      tech: ["React", "Tailwind CSS", "Express", "Mongo DB", "Cloudinary"],
      icon: "fa-book-open",
      color: "from-amber-500 to-orange-500",
      links: {
        github: "https://github.com/rupayansen23/Bookloversa",
        live: null
      }
    },
    {
    ...
    },
    {
      ...
      tech: ["React", "Express.js", "MongoDB", "Redis", "Judge0 API"],
      icon: "fa-code",
  ...
  return (
    <section id="projects" className="py-20 bg-linear-to-br from-blue-50 via-cyan-50 to-teal-50 dark:from-gray-900 dark:via-blue-900/10 dark:to-cyan-900/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-center mb-4 dark:text-white">
          Featured <span className="gradient-text">Projects</span>
        </h2>
        <div className="w-24 h-1 bg-linear-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 mx-auto mb-12 rounded-full"></div>
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="card-hover bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-blue-100 dark:border-blue-900/50 relative">
              <div className={`bg-linear-to-r ${project.color} p-8 text-white text-center relative overflow-hidden`}>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map(tech => (
                    <span 
                      key={tech}
                      className="bg-linear-to-r from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-600 px-3 py-1 rounded-full text-xs font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-500 hover:shadow-md transition-all"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="relative project-menu-container">
                  <button
                    ...
                    className="w-full bg-linear-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    ...
                    <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-gray-700 rounded-lg shadow-2xl border-2 border-purple-300 dark:border-purple-600 overflow-hidden z-10 animate-slideUp">
                      {project.links.live && (
                        <a
                          ...
                          className="block px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-linear-to-r hover:from-purple-600 hover:to-blue-600 hover:text-white transition-all duration-300 border-b border-gray-200 dark:border-gray-600"
                        >
                      ...
                      {project.links.github && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-linear-to-r hover:from-purple-600 hover:to-blue-600 hover:text-white transition-all duration-300"
                        >
